Second flag of Darkly guys are we excited or what!

1.) Where to find the flag
http://192.168.1.100/index.php?page=searchimg

2.) Now that we are on the page here we can try for simple sql Injection by passing 1 , 1=1 or even passing 1 or 1 = 1
...
3.) Same as the prev flag we are going to try and get table name of the table here
''
...
4.) There after we are going to get the columns again too
''
...
when we decode the given data we get the following string --> albatroz

sha 256 calculator result after passing in albatroz -->   f2a29020ef3132e01dd61df97fd33ec8d7fcd1388cc9601e7db691d17d4d6188
